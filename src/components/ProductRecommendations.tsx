...
const getRecommendedProducts = (customerData: CustomerData): Product[] => {
  ...
  const isHighIncome = income > 300000;
  const isMediumIncome = income > 100000 && income <= 300000;
...
const getCategoryColor = (category: string) => {
    const colors = {
      'Premium': 'bg-purple-600 text-white border-purple-700',
      'Travel': 'bg-blue-600 text-white border-blue-700',
      'International': 'bg-green-600 text-white border-green-700',
      'Credit': 'bg-orange-600 text-white border-orange-700',
      'Mortgage': 'bg-indigo-600 text-white border-indigo-700',
      'Savings': 'bg-emerald-600 text-white border-emerald-700',
      'Debit': 'bg-rose-600 text-white border-rose-700',
      'Auto': 'bg-cyan-600 text-white border-cyan-700',
      'Lifestyle': 'bg-pink-600 text-white border-pink-700',
      'Youth': 'bg-lime-600 text-white border-lime-700',
      'Investment': 'bg-amber-600 text-white border-amber-700',
      'Business': 'bg-gray-600 text-white border-gray-700',
    };
